...
function () {
  ...
  _createClass(Interface, [{
    ...
    value: function buildStyle() {
      ...
      '#cconsent-bar { background-color: rgba(0,0,0,0.5); color:' + window.CookieConsent.config.theme.barTextColor + '; padding:15px; text-align:right; font-family:sans-serif; font-size:14px; line-height:18px; position:fixed; top:0; bottom:0; left:0; width:100%; z-index:9998;}',
      '#cconsent-bar.ccb--hidden {display:none;}',
      '#cconsent-bar .ccb__wrapper { position: fixed; top: 50%; left: 50%; width: 95%; max-width: 500px; transform: translate(-50%, -50%); padding: 20px; border-radius: .2rem; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px; background-color:' + window.CookieConsent.config.theme.barColor + ';}',
      '#cconsent-bar .cc-text { text-align:justify;}',
      '#cconsent-bar .cc-text p { margin-bottom: 14px;}',
      '#cconsent-bar .ccb__left { text-align:left; margin-bottom: 20px;}',
      '#cconsent-bar .ccb__right {text-align: left;}',
      '#cconsent-bar .ccb__right > div {display:inline-block; color:#FFF;}',
      '#cconsent-bar a { text-decoration:underline; color:' + window.CookieConsent.config.theme.barTextColor + '; }',
      '#cconsent-bar button { line-height:normal; font-size:14px; border:none; padding:8px 16px; border-radius: 15px; color:' + window.CookieConsent.config.theme.barMainButtonTextColor + '; background-color:' + window.CookieConsent.config.theme.barMainButtonColor + ';}',
      '#cconsent-bar a.ccb__edit { margin-left:30px }',
      ...
      '#cconsent-modal .ccm__footer button:hover { background-color:' + _Utilities.default.lightenDarkenColor(window.CookieConsent.config.theme.modalMainButtonColor, 50) + '; }',
      '#cconsent-modal .ccm__footer button#ccm__footer__consent-modal-submit {  margin-right:10px; }');
    }
  }, {
    key: "buildBar",
    value: function buildBar() {
      return (0, _redom.el)('div#cconsent-bar.ccb--hidden', (0, _redom.el)("div.ccb__wrapper", (0, _redom.el)('div.ccb__left', (0, _redom.el)('div.cc-text', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'barMainText'))), (0, _redom.el)('div.ccb__right', (0, _redom.el)('div.ccb__button', (0, _redom.el)('button.consent-give', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'barBtnAcceptAll')), (0, _redom.el)('a.ccb__edit', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'barLinkSetting'))))));
    }
  }, {
    key: "buildModal",
    ...
    value: function buildInterface(callback) {
      ...
      _Utilities.default.ready(function () {
        ...
        that.render('bar', that.buildBar(), function (bar) {
          // BUGFIX: set html from text
          var ccText = jQuery('.cc-text', bar);
          ccText.html(
            ccText.text()
          );
